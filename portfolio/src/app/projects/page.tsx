export default function Projects() {
  ...
  return (
    <section className="mt-5">
      ...
      <ul className="py-10 w-[100%] flex justify-center gap-8">
        {projects.map((project, index) => (
          <li
            key={index}
            className="w-fit basis-[200px] border-2 rounded-lg border-gray-400 flex flex-col items-center justify-center p-6"
          >
